...
<a href="register.jsp"><input type="button" value="注册"></input></a>
 ...
 <tr>
 <td><div align="right"><font color="#000000">姓名</font>:</div></td>
 <td><div align="left"><input type="text" name="name" required/></div></td>
 </tr>
  <tr>
 <td><div align="right"><font color="#000000">学号</font>:</div></td>
 <td><div align="left"><input type="text" name="id" required/></div></td>
 </tr>
 
  <tr>
 <td><div align="right"><font color="#000000">密码</font>:</div></td>
 <td align="left"><input type="password" name="password" required></td>
 </tr>
 

 <tr>
 <td><div align="right"><font color="#000000">重复密码</font>:</div></td>
 <td align="left"><input type="password" name="re_password" required></td>
 </tr>
  <tr>
 <td><div align="right"><font color="#000000">性别</font>:<br></div></td>
 <td>
 
 <div align="left">
 男：<input type="radio" name="sex" value="man" required/>
 女：<input type="radio" name="sex" value="woman" required/>
 ...
 <tr>
  <td><div align="right"><font color="#000000">学院</font>:</div></td>
 <td align="left"><input type="" name="academy" required></td>
 </tr>
 <tr>
  <td><div align="right"><font color="#000000">手机</font>:</div></td>
