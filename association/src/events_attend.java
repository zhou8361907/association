...
public class events_attend extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public events_attend() {
		super();
	}
	...
	java.sql.Connection conn=null;
		...
		try{
			...
			String join_sql="SELECT * FROM attend WHERE s_id='"+s_id+"' AND e_id='"+e_id+"' ";
		out.println(join_sql);
			...
			String sql = "insert into attend values('"+s_id+"','"+e_id+"')";
