...
import as.student;
import show.DB;
public class as_join extends HttpServlet {
	...
	java.sql.Connection conn=null;
		...
		try{
			...
			String join_sql="SELECT * FROM appli WHERE s_id='"+s_id+"' AND a_id='"+a_id+"' ";
			...
			String sql = "insert into appli values('"+s_id+"','"+a_id+"','"+part+"')";
