				...
				<!-- 用户列表--bootstrap高级表格使用 -->
					<div class="panel panel-success">
							...
							<div class="panel-heading col-md-6" style="text-align: right; height: 41px;">
								<a href="/admin/Good2ImageServlet?id=${good.goods_id}">
								<button type="button" id="btnBack" class="btn btn-success" style="margin-top:-7px">返回</button>
								</a>
							</div>
							<br><br>
					<div class="panel-body">
						<form action="/admin/Good2ImageServlet?flag=add" method="post" enctype="multipart/form-data">
							<input type="hidden" name="id" value="${image.image_id}">							
							<input type="hidden" name="good_id" value="${good.goods_id}">
							<div class="form-group">
								
								<label for="good_name">商品名称：${good.goods_name }</label> 
