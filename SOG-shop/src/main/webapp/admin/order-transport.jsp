					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="table-responsive">
								<!-- <a href="/admin/AdminServlet?flag=add"> --><input class="btn btn-success" type="button" value="添加发货订单信息"><!-- </a> -->
								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<c:forEach items="${map.list}" var="order">
										<tr class="odd gradeX">
											...
											<td class="center">未付款</td>
											</c:if> 
											
								            <c:if test="${order.orderStage>0&&order.orderStage<2}">					
											<td class="center">未发货</td>
											</c:if> 
											
											<c:if test="${order.orderStage>1&&order.orderStage<3}">
											...
											<td>
											<form action="/admin/OrdersServlet?id=${order.orderId}&flag=edit&cur=${curPage}&selectid=0" method="post">
											<select name="change">
							...
							<div class="row">
								...
								<div class="col-md-6" style="text-align: right;">
									<ul class="pagination" style="margin: 0px;">
										<c:if test="${curPage>1}">
											<li><a href="/admin/OrdersServlet?selectid=0&curPage=${curPage-1}"
									...
									<c:forEach var="i" begin="${begin }" end="${end }">
										<c:choose>
											...
											<c:otherwise>
												<li><a href="/admin/OrdersServlet?selectid=0&curPage=${i}">${i}</a></li>
